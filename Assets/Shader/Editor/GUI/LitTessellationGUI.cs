...
namespace UnityEditor.Rendering.Universal.ShaderGUI
{
    public static class LitTessellationGUI
    {
        ...
        public static class Styles
        {
            ...
            public static GUIContent vertexColorDispBiasText = new GUIContent("Bias");
        ...
        public struct LitTessellationProperties
        {
            ...
            public MaterialProperty vertexColorDispBias;
            ...
            public LitTessellationProperties(MaterialProperty[] properties)
            {
                ...
                vertexColorDispBias = BaseShaderGUI.FindProperty("_VertexColorDispBias", properties);
        ...
        public static void GeometryInputs(LitTessellationProperties properties, MaterialEditor materialEditor)
        {
            // vertex color
            DoVertexColor(properties, materialEditor);

            // tesellation
            DoTessellation(properties, materialEditor);

            // height
            DoHeight(properties, materialEditor);
        }

        public static void DoVertexColor(LitTessellationProperties properties, MaterialEditor materialEditor)
        {
            // Vertex color
            ...
            if (vertexColor)
            {
                ...
                if (vertexColorMode != VertexColorMode.Displacement)
                {
                    EditorGUI.BeginChangeCheck();
                ...
                // Vertex Color Disp Bias
                if (vertexColorMode == VertexColorMode.Displacement)
                {
                    EditorGUI.BeginChangeCheck();
                    EditorGUI.showMixedValue = properties.vertexColorDispBias.hasMixedValue;
                    var vertexColorDispBias = EditorGUILayout.Slider(Styles.vertexColorDispBiasText, properties.vertexColorDispBias.floatValue, -1f, 1f);
                    if (EditorGUI.EndChangeCheck())
                    {
                        properties.vertexColorDispBias.floatValue = vertexColorDispBias;
                    }
                    EditorGUI.showMixedValue = false;
                }
        ...
        public static void DoTessellation(LitTessellationProperties properties, MaterialEditor materialEditor)
        {
            // Tessellation Map
        ...
        public static void DoHeight(LitTessellationProperties properties, MaterialEditor materialEditor)
        {
        ...
        public static void GeometryAdvanced(LitTessellationProperties properties, MaterialEditor materialEditor)
        {
            // Geometry Custom ST
            EditorGUI.BeginChangeCheck();
        ...
        public static void SetMaterialKeywords(Material material)
        {
            ...
            CoreUtils.SetKeyword(material, "_VERTEX_COLOR_DISPLACEMENT", vertexColorMode == VertexColorMode.Displacement);
