...
TEXTURE2D(_2ndBaseMap);
SAMPLER(sampler_2ndBaseMap);
float4 _2ndBaseMap_TexelSize;
float4 _2ndBaseMap_MipInfo;
...
// NOTE: Dots instancing is orthogonal to the constant buffer above.
    ...
    UNITY_DOTS_INSTANCING_START(MaterialPropertyMetadata)
        ...
        UNITY_DOTS_INSTANCED_PROP(float , _VertexColorDispBias)
    ...
    #define _VertexColorDispBias                UNITY_DOTS_INSTANCED_PROP(float , _VertexColorDispBias)
...
#elif VERTEX_STATIC_LIGHTMAP_UV
    #define HAS_UV1 1
    #define HAS_VERTEX_UV1 1
    #define UV1_ID staticLightmapUV
...
#elif VERTEX_DYNAMIC_LIGHTMAP_UV
    #define HAS_UV2 1
    #define HAS_VERTEX_UV2 1
    #define UV2_ID dynamicLightmapUV
...
// Vertex Color
#if _VERTEX_COLOR
    #if defined(GEOMETRY_VERTEX_COLOR) || defined(PIXEL_VERTEX_COLOR)
...
inline void InitializeStandardLitSurfaceData(float2 uv, out SurfaceData outSurfaceData)
{
    ...
    half4 albedoAlpha2 = SampleAlbedoAlpha(uv, TEXTURE2D_ARGS(_2ndBaseMap, sampler_2ndBaseMap));
    albedoAlpha += albedoAlpha2;
