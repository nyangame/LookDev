Shader "Universal Render Pipeline/Custom/Lit Tessellation"
{
	Properties
	{
        ...
        [Texture]_2ndBaseMap("Albedo", 2D) = "white" {}
        ...
        _VertexColorDispBias("VertexColorDispBias", Float) = 0.0
	...
	SubShader
	{
        ...
        Pass
        {
            ...
            #pragma shader_feature _VERTEX_COLOR_DISPLACEMENT
			...
			#define VERTEX_STATIC_LIGHTMAP_UV 1
            #define VERTEX_DYNAMIC_LIGHTMAP_UV 1

			// Geometry Inputs
            #define GEOMETRY_VERTEX_COLOR 1
            ...
            #include "Assets/Shader/Library/LitTessellationInput.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Shaders/LitForwardPass.hlsl"
            #include "Assets/Shader/Library/LitTessellationStructs.hlsl"
            #include "Assets/Shader/Library/LitTessellationPasses.hlsl"
        ...
        Pass
        {
            ...
            #define PassFragmentProgram UniversalFragmentMetaLit
